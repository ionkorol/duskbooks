...
const TOS = () => {
  return (
    <Layout title="Terms of Service Policy | DuskBooks.com">
      <h1>Terms of Service Policy</h1>
      <strong>OVERVIEW</strong> <br /> This website is operated by DuskBooks.
      Throughout the site, the terms “we”, “us” and “our” refer to DuskBooks.
      DuskBooks offers this website, including all information, tools and
      ...
      <br /> <br /> By visiting our site and/ or purchasing something from us,
      you engage in our “Service” and agree to be bound by the following terms
      and conditions (“Terms of Service”, “Terms”), including those additional
      ...
      Terms of Service. If you do not agree to all the terms and conditions of
      ...
      limited to these Terms of Service. <br /> <br /> Any new features or tools
      ...
      changes. <br /> <br /> Our store is hosted on Shopify Inc. They provide us
      with the online e-commerce platform that allows us to sell our products
      and services to you. <br /> <br />{" "}
      ...
      nature. <br /> A breach or violation of any of the Terms will result in an
      ...
      understand that your content (not including credit card information), may
      ...
      encrypted during transfer over networks. <br /> You agree not to
      ...
      permission by us. <br /> The headings used in this agreement are included
      ...
      it is your responsibility to monitor changes to our site. <br /> <br />{" "}
      ...
      accurate. <br /> We reserve the right, but are not obligated, to limit the
      ...
      product or service made on this site is void where prohibited. <br /> We
      ...
      or that any errors in the Service will be corrected. <br /> <br />{" "}
      <strong>SECTION 6 - ACCURACY OF BILLING AND ACCOUNT INFORMATION</strong>{" "}
      <br /> We reserve the right to refuse any order you place with us. We may,
      ...
      distributors. <br /> <br /> You agree to provide current, complete and
      ...
      <br /> <br /> For more detail, please review our Returns Policy. <br />{" "}
      <br /> <strong>SECTION 7 - OPTIONAL TOOLS</strong> <br /> We may provide
      you with access to third-party tools over which we neither monitor nor
      have any control nor input. <br /> You acknowledge and agree that we
      ...
      relating to your use of optional third-party tools. <br /> Any use by you
      of optional tools offered through the site is entirely at your own risk
      ...
      third-party provider(s). <br /> We may also, in the future, offer new
      services and/or features through the website (including, the release of
      new tools and resources). Such new features and/or services shall also be
      subject to these Terms of Service. <br /> <br />{" "}
      ...
      third-parties. <br /> Third-party links on this site may direct you to
      third-party websites that are not affiliated with us. We are not
      responsible for examining or evaluating the content or accuracy and we do
      ...
      should be directed to the third-party. <br /> <br />{" "}
      ...
      (3) to respond to any comments. <br /> We may, but have no obligation to,
      ...
      property or these Terms of Service. <br /> You agree that your comments
      ...
      our Privacy Policy. To view our Privacy Policy. <br /> <br />{" "}
      ...
      you have submitted your order). <br /> We undertake no obligation to
      ...
      updated. <br /> <br /> <strong>SECTION 12 - PROHIBITED USES</strong>{" "}
      ...
      website for violating any of the prohibited uses. <br /> <br />{" "}
      <strong>
        SECTION 13 - DISCLAIMER OF WARRANTIES; LIMITATION OF LIABILITY
      </strong>{" "}
      <br /> We do not guarantee, represent or warrant that your use of our
      service will be uninterrupted, timely, secure or error-free. <br /> We do
      ...
      the service at any time, without notice to you. <br /> You expressly agree
      ...
      for a particular purpose, durability, title, and non-infringement. <br />{" "}
      In no case shall DuskBooks, our directors, officers, employees,
      ...
      be limited to the maximum extent permitted by law. <br /> <br />{" "}
      <strong>SECTION 14 - INDEMNIFICATION</strong> <br /> You agree to
      indemnify, defend and hold harmless DuskBooks and our parent,
      ...
      <br /> <br /> <strong>SECTION 15 - SEVERABILITY</strong> <br /> In the
      event that any provision of these Terms of Service is determined to be
      ...
      enforceability of any other remaining provisions. <br /> <br />{" "}
      ...
      our site. <br /> If in our sole judgment you fail, or we suspect that you
      ...
      <strong>SECTION 17 - ENTIRE AGREEMENT</strong> <br /> The failure of us to
      exercise or enforce any right or provision of these Terms of Service shall
      not constitute a waiver of such right or provision. <br /> These Terms of
      Service and any policies or operating rules posted by us on this site or
      ...
      construed against the drafting party. <br /> <br />{" "}
      <strong>SECTION 18 - GOVERNING LAW</strong> <br /> These Terms of Service
      and any separate agreements whereby we provide you Services shall be
      governed by and construed in accordance with the laws of Gabon. <br />{" "}
      ...
      time at this page. <br /> We reserve the right, at our sole discretion, to
      ...
      of Service constitutes acceptance of those changes. <br /> <br />{" "}
      <strong>SECTION 20 - CONTACT INFORMATION</strong> <br /> Questions about
      the Terms of Service should be sent to us at contact@duskbooks.com.
    </Layout>
  );
};
